      ...
      <div class="col-lg-3">
        <div class="card" style="min-height: 86vh;">
          <div class="card-body">
            ...
            <a href="pengaturan.php" class="btn btn-light btn-block text-left mt-4"><i class="fas fa-cog"
                style="margin-right: 10px;"></i>Pengaturan
              Saya</a>
            <a href="sertifikatsaya.php" class="btn btn-light btn-block text-left active"><i class="fas fa-sticky-note"
        ...
        <div class="row">
          <div class="col-md-4">
            <div class="card" style="padding: 10px;">
              <img
                src="https://1.bp.blogspot.com/-FsciUQ8XVvo/Xn0_ND7FxhI/AAAAAAAABO4/cBy5tJF1pDAp3H8A5BwfitRvzXcH6BdKQCLcBGAsYHQ/s1600/certificate.png"
                class="card-img-top" style="height: 200px;">
              <div class="card-body">
                <h5 class="card-title mb-0">Sertifikat DO IT</h5>
                <p class="lead mb-0">SRTFKT-19106XXXXXXX</p>
                <p class="card-text">Universitas Singaperbangsa Karawang</p>
                <a href="#" class="btn btn-info">Lihat Sertifikat</a>
              </div>
            </div>
          </div>
          <div class="col-md-4">
